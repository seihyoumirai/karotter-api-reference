...
| [バッジ一覧](#バッジ一覧) | バッジについて |
| [サブスクリプションプラン一覧](#サブスクリプションプラン一覧) | サブスクリプションプラン一覧 |
...
| 名前 | 入手方法 |
|-----|--------|
| なし | 認証バッジの扱いがが配列への変更時にバグで生まれた。現在は存在しない。白色のバッジだった。 |
...
| `PRO` | Plusの全特典 / バッジ: 任意の色のバッジを1つ / 投稿文字数: 1000文字 / 固定カロート: 5個 / プロフィール・カード装飾 / アップロード: 200MB |
| `BADGE_RED` | バッジ: 赤 |
| `BADGE_GREEN` | バッジ: 緑 |
